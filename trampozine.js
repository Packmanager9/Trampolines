...
window.addEventListener('DOMContentLoaded', (event) => {
    ...
    function setUp(canvas_pass, style = "#000000") {
        ...
        window.addEventListener('pointerdown', e => {
            ...
            let ball = new Circle(TIP_engine.x, TIP_engine.y, 10, "#FFFF00", -10 , 2)
            balls.push(ball)
...
//         console.log(gamepadAPI.axesStatus[1]*gamepadAPI.axesStatus[0]) //debugging
    ...
    class Trampozine{
        constructor(point, point2){
            ...
            this.link1 = new LineOP(point, this.point3, "#FFFFFF", 3)
            this.link2 = new LineOP(point2, this.point3, "#FFFFFF", 3)
            this.bar1 = castBetweenRat(point, this.point3, 100, 3)
        ...
        localize(){
            ...
            for(let t = 0;t<balls.length;t++){
                if(this.bar1.doesPerimeterTouch(balls[t])){
                    this.point3.x+=balls[t].xmom*4
                    this.point3.y+=balls[t].ymom*4
                    // this.point3.x = ((this.point3.x*10) + balls[t].x)/11
                    // this.point3.y = ((this.point3.y*10) + balls[t].y)/11
                    balls[t].xmom-=this.tension.hypotenuse()*Math.cos(this.tension.angle())*.5
                    balls[t].ymom-=this.tension.hypotenuse()*Math.sin(this.tension.angle())*.5
                }else if(this.bar2.doesPerimeterTouch(balls[t])){
                    this.point3.x+=balls[t].xmom*4
                    this.point3.y+=balls[t].ymom*4
                    // this.point3.x = ((this.point3.x*10) + balls[t].x)/11
                    // this.point3.y = ((this.point3.y*10) + balls[t].y)/11
                    ...
                    this.point3.x = ((this.point3.x*5) + this.point3sto.x)/6
                    this.point3.y = ((this.point3.y*5) + this.point3sto.y)/6
    ...
    // let point1 = new Point(400,300)
    // let point2 = new Point(550,400)

    // let trm = new Trampozine(point2, point1)
    

    // let point14= new Point(900,400)
    // let point24= new Point(1050,300)

    // let trm2 = new Trampozine(point24, point14)

    class Springoline{
        constructor(point, point2){
            this.segs = []
            this.segs = castBetweenRat(point, point2, 20, 3)
            for(let t = 0;t<this.segs.shapes.length;t++){
                for(let k = 0;k<this.segs.shapes.length;k++){
